...
RPMgr is built with the QT libraies. You will need to have the qt5pas library installed before running RPMgr
...
This will cure the problem that wayland has of moving windows around on the screen by forcing it to use x11 screen calls. This only affects the action panel when installing, removing, or reinstalling. Once this is fixed that commandline will not be needed.
